...
const BookAppointmentIllustration = () => (
  <Svg width={220} height={200} viewBox="0 0 220 200">
    ...
    {/* Stethoscope */}
    <Path
      d="M155 95 Q160 110 168 112 Q176 110 181 95"
      stroke="white"
      strokeWidth="3"
      fill="none"
      opacity="0.9"
    ...
    {/* Doctor coat */}
    <Path
      d="M150 92 Q158 84 168 82 Q178 84 186 92 L183 130 Q168 138 153 130 Z"
      fill="white"
      opacity="0.9"
    />
...
const ChatIllustration = () => (
  <Svg width={220} height={200} viewBox="0 0 220 200">
    ...
    <Path
      d="M168 88 Q175 78 182 76 Q189 78 196 88"
      fill="#34C759"
      opacity="0.9"
    />
    {/* Wifi/signal icons */}
...
const NotificationsIllustration = () => (
  <Svg width={220} height={200} viewBox="0 0 220 200">
    ...
    {/* Bell icon centered */}
    <Path
      d="M110 45 C110 45 95 52 95 75 L90 90 L130 90 L125 75 C125 52 110 45 110 45 Z"
      fill="#FF9F0A"
      opacity="0.15"
    />
    <Path
      d="M110 45 C110 45 97 53 97 75 L92 88 L128 88 L123 75 C123 53 110 45 110 45 Z"
      fill="#FF9F0A"
    />
...
const MedicalHistoryIllustration = () => (
  <Svg width={220} height={200} viewBox="0 0 220 200">
    ...
    {/* Folder tab */}
    <Path
      d="M30 68 Q30 55 42 55 L85 55 L93 68 L30 68 Z"
      fill="#BF5AF2"
      opacity="0.4"
    />
    <Rect
    ...
    {/* Heartbeat line */}
    <Path
      d="M30 165 Q50 165 60 165 L70 148 L80 175 L90 155 L100 165 Q120 165 160 165"
      stroke="#FF375F"
      strokeWidth="3"
      fill="none"
      strokeLinecap="round"
    ...
    />
    <Path
      d="M174 144 Q174 138 178 138 Q182 138 182 144"
      stroke="white"
      strokeWidth="2.5"
      fill="none"
    />
...
const FollowUpIllustration = () => (
  <Svg width={220} height={200} viewBox="0 0 220 200">
    ...
    <Path
      d="M158 80 Q158 68 170 68 Q182 68 182 80 L178 80 L183 87 L188 80 L184 80 Q184 64 170 64 Q156 64 156 80 Z"
      fill="white"
      opacity="0.9"
    />
    <Path
      d="M182 80 Q182 92 170 92 Q158 92 158 80 L162 80 L157 73 L152 80 L156 80 Q156 96 170 96 Q184 96 184 80 Z"
      fill="white"
      opacity="0.9"
    />
    {/* Check items */}
...
const onboardingSlides = [
  {
    ...
    description:
      "Schedule with your preferred doctors instantly.\nChoose from available time slots that work for you.",
    gradientColors: ["#1A73E8", "#0A84FF", "#5E5CE6"] as [
      string,
      string,
      string,
    ],
  ...
  },
  {
    ...
    description:
      "Get quick medical advice through secure chat.\nDiscuss symptoms and receive guidance anytime.",
    gradientColors: ["#0D7A3E", "#32D74B", "#30DB84"] as [
      string,
      string,
      string,
    ],
  ...
  },
  {
    ...
    description:
      "Receive reminders for appointments and medication\nschedules. Never miss an important follow-up.",
    gradientColors: ["#CC6600", "#FF9F0A", "#FFCC00"] as [
      string,
      string,
      string,
    ],
  ...
  },
  {
    ...
    description:
      "Access your complete medical records, prescriptions\nand treatment history in one secure place.",
    gradientColors: ["#6B2FA0", "#BF5AF2", "#FF375F"] as [
      string,
      string,
      string,
    ],
  ...
  },
  {
    ...
    description:
      "Get timely reminders for follow-ups, medication\nrefills and regular health checkups.",
    gradientColors: ["#CC2200", "#FF453A", "#FF375F"] as [
      string,
      string,
      string,
    ],
...
const spotlightItems = [
  ...
  },
  {
    ...
    description:
      "Drag and drop the chat button anywhere. Tap to get instant AI medical assistance",
    icon: "chat",
        ...
        >
          <Animated.View
            style={[
              ...
              {
                backgroundColor:
                  i === currentSlide ? "#FFFFFF" : "rgba(255,255,255,0.4)",
    ...
    return (
      <Animated.View style={[styles.spotOverlay, { opacity: fadeAnim }]}>
        ...
        <View
          style={[
            styles.cutout,
            {
              ...
              borderRadius:
                item.targetArea.height < 70
                  ? (item.targetArea.height + 16) / 2
                  : 20,
            },
          ]}
        >
        ...
        <Animated.View
          style={[
            styles.tooltip,
            { top: tipTop, left: tipLeft2 },
            { opacity: fadeAnim },
          ]}
        >
          <LinearGradient
            colors={item.gradientColors}
            style={styles.tooltipGrad}
          >
            {/* Arrow */}
            <View
              style={[
            ...
            <View style={styles.tooltipProgress}>
              {spotlightItems.map((_, i) => (
                <View
                  ...
                  style={[
                    styles.progressPill,
                    i === currentSpotlightIndex && styles.progressPillActive,
                  ]}
                />
              ))}
            </View>
        ...
        <View style={styles.spotFooter}>
          ...
          <View style={styles.spotNavRow}>
            {!isFirst && (
              <TouchableOpacity
                style={styles.spotPrevBtn}
                onPress={() => setCurrentSpotlightIndex((i) => i - 1)}
              >
            ...
            >
              <Text style={styles.spotNextText}>
                {isLast ? "Done ✓" : "Next"}
              </Text>
              {!isLast && (
...
const styles = StyleSheet.create({
  ...
  skipText: { color: "#FFFFFF", fontSize: 15, fontWeight: "600" },
  ...
  // Slide
  slideWrapper: { height: "100%", width },
  slideGradient: { alignItems: "center", flex: 1, justifyContent: "center" },

  decorCircle: { borderRadius: 999, opacity: 0.12, position: "absolute" },
  decorCircle1: { height: 320, right: -80, top: -80, width: 320 },
  decorCircle2: { bottom: -60, height: 250, left: -60, width: 250 },
  ...
  cutoutInner: { backgroundColor: "transparent", borderRadius: 999, flex: 1 },
  ...
  arrowTop: { borderBottomColor: "#32D74B", borderBottomWidth: 12, top: -12 },
  arrowBottom: { borderTopColor: "#32D74B", borderTopWidth: 12, bottom: -12 },
  ...
  progressPillActive: { backgroundColor: "#FFFFFF", width: 28 },
  ...
  tooltipDesc: { color: "rgba(255,255,255,0.9)", fontSize: 14, lineHeight: 21 },
  ...
  spotSkipBtn: { paddingHorizontal: 4, paddingVertical: 10 },
  spotSkipText: {
  ...
  spotNextText: { color: "#FFFFFF", fontSize: 15, fontWeight: "700" },
});
